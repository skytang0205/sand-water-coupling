...
inline void solve(const MatrixType &A, Eigen::Ref<VectorXr, Eigen::Aligned> x, const Eigen::Ref<const VectorXr, Eigen::Aligned> &b, const int maxIterations = 999, const real tolerance = real(1e-6))
{
	Solver solver(A);
